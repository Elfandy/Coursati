...
BoxTCLabelData trainingCenter = BoxTCLabelData(name: "", image: "", logo: "", id: "");
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      ...
      builder:(context, snapshot) {
                            ...
                            child: InkWell(
                              ...
                              onTap: () {
                                Navigator.of(context).push(ScreenController()
                                    .createRoute(
                                        TrainingCenterPersonal(id: trainingCenter.id!,mainBranch: true), 1));
                              },
        ...
        return Container(child: Text("Your request took to long"),);
      }
      }else {
  ...
  Future GetData() async {
    ...
    try{
      ...
      if(response.statusCode == 200){
        ...
        Map<String,dynamic> trainingCenterjson = response.data["TrainingCenter"];
