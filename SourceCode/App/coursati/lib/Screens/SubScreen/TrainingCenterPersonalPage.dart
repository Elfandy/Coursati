...
class TrainingCenterPersonal extends StatefulWidget {
  TrainingCenterPersonal({super.key, required this.id,required this.mainBranch});
  String id;
  bool mainBranch;
         ...
         Scaffold(
           body: FutureBuilder(
            ...
            if(snapshot.data != null){
                AllTrainingCenterData Data=AllTrainingCenterData.fromJson(snapshot.data);
            return Scaffold(
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                            image: DecorationImage(
                                image: CachedNetworkImageProvider(Data.tcData!.image),
                                fit: BoxFit.cover),
                          ),
                          child: Container(
                                ...
                                child: TextButton(
                                  ...
                                  onPressed: () {
                                    Navigator.of(context).push(ScreenController()
                                        .createRoute(
                                             TrainingCenterParsonalInfo(tc:Data.tcData!), 1));
                                  },
                                  child: Row(
                      ...
                      Container(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Wrap(children: [
                                for (int i = 0; i < ((Data.courses.length > 4)? 4:Data.courses.length); i++)
                                  PersonalCourseBox(
                                    bld: Data.courses[i],
                                  ),
                              ]),
                      ...
                      Container(
                        child: Column(
                          ...
                          children: [
                            ...
                            for(int i =0 ;i<((Data.trainers.length>4)?3:Data.trainers.length);i++)
                              Padding(
...
try{
  var response = await dioTestApi.post(url,data:{"id":user.id,"trainingCenter":id});
